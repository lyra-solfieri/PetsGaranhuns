...
// Colors
const Color lightBackgroundColor = Color.fromARGB(255, 206, 216, 204);
const Color verdepapagaio = Color.fromRGBO(77, 228, 63, 1);
const Color azulbeijaflor = Color.fromARGB(255, 16, 19, 151);
...
// Assets
const String passarosJsonPath = 'assets/data/passaros.json';
